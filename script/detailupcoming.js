...
function printCard(index){
    ...
    <div class="container bigCard">
        <div class="row upcoming" id="tarjetaupcoming">
        <div class="close">
            <a href="./upcoming.html">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bix bi-x-circle-fill"
                viewBox="0 0 20 20">
                <path
        ...
        <div class="contenido">
            ...
            <h6>Date:<p id="fecha">${event.date}</p>
            </h6>
            <h6>Descripcion:<p id="descripcion">${event.description}</p>
            </h6>
            <h6>Category:<p id="categoria">${event.category}</p>
            </h6>
            <h6>Place:<p id="lugar">${event.place}</p>
            </h6>
            <h6>Capacity:<p id="capacidad">${event.capacity}</p>
            </h6>
            <h6>Assistance:<p id="asistencia">${event.assistance}</p>
            </h6>
            <h6>Price: $<p id="precio">${event.price}</p>
            </h6>
            </p>
        </div>
        </div>
